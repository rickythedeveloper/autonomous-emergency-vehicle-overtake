...
from .algorithms.discrete.algorithm1 import DiscreteCivilianVehicle, DiscreteEmergencyVehicle
from .models.discrete.utils import DiscreteSimulationCellType, Grid
from .scenarios.discrete.scenario1 import scenario
...
def discrete_main():
	...
	civilians = [DiscreteCivilianVehicle(c.position) for c in scenario.civilians]
	emergencies = [DiscreteEmergencyVehicle(e.position) for e in scenario.emergencies]
